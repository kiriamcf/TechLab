<x-app-layout>
    <script>
        function handler(e) {
            const data = { maquina: '{{ $machine->id }}', date: e.target.value, array_h: @json(\App\Models\Reservation::$hours) };
                    ...
                    <div class="flex justify-center">
                        <form class ="flex flex-col justify-center pt-8" action="{{ route('reservation.show', $machine) }}" enctype="multipart/form-data" method="POST">  
                            ...
                            <div class="flex justify-center">
                                ...
                                <input required type="date" onchange="handler(event);" name="date" min={{ now()->toDateString('Y-m-d') }}>
                            </div>
                            ...
                            <ul class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-5 m-4 max-w-mlg mx-auto">
                                <li class="relative">
                                    <input required class="sr-only peer" type="radio" value="08-09" name="answer" id="answer_08-09">
                                    <label id="label_08-09" class="flex p-5 bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-blue-50 peer-checked:ring-blue-500 peer-checked:ring-2 peer-checked:border-transparent peer-checked:bg-blue-100" for="answer_08-09">08:00 - 09:00</label>
                                </li>
                                <li class="relative">
                                    <input required class="sr-only peer" type="radio" value="09-10" name="answer" id="answer_09-10">
                                    <label id="label_09-10" class="flex p-5 bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-blue-50 peer-checked:ring-blue-500 peer-checked:ring-2 peer-checked:border-transparent peer-checked:bg-blue-100" for="answer_09-10">09:00 - 10:00</label>
                                </li>
                                <li class="relative">
                                    <input required class="sr-only peer" type="radio" value="10-11" name="answer" id="answer_10-11">
                                    <label id="label_10-11" class="flex p-5 bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-blue-50 peer-checked:ring-blue-500 peer-checked:ring-2 peer-checked:border-transparent peer-checked:bg-blue-100" for="answer_10-11">10:00 - 11:00</label>
                                </li>
                                <li class="relative">
                                    <input required class="sr-only peer" type="radio" value="11-12" name="answer" id="answer_11-12">
                                    <label id="label_11-12" class="flex p-5 bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-blue-50 peer-checked:ring-blue-500 peer-checked:ring-2 peer-checked:border-transparent peer-checked:bg-blue-100" for="answer_11-12">11:00 - 12:00</label>
                                </li>
                                <li class="relative">
                                    <input required class="sr-only peer" type="radio" value="15-16" name="answer" id="answer_15-16">
                                ...
                                <li class="relative">
                                    <input required class="sr-only peer" type="radio" value="16-17" name="answer" id="answer_16-17">
                                ...
                                <li class="relative">
                                    <input required class="sr-only peer" type="radio" value="17-18" name="answer" id="answer_17-18">
                                ...
                                <li class="relative">
                                    <input required class="sr-only peer" type="radio" value="18-19" name="answer" id="answer_18-19">
                                ...
                                <li class="relative">
                                    <input required class="sr-only peer" type="radio" value="19-20" name="answer" id="answer_19-20">
                                ...
                                <li class="relative">
                                    <input required class="sr-only peer" type="radio" value="20-21" name="answer" id="answer_20-21">
